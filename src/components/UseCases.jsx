        ...
        <section id="use-cases" className="bg-striped bg-striped-sm bg-striped-bottom bg-dark-blue-4 py-20 py-lg-30">
            <div className="container">
                ...
                <p className="text-primary-dark" data-aos="fade-up-sm" data-aos-delay="50">
                    Ijaad Labs Use Cases
                </p>
                <h1 className="text-white mb-0" data-aos="fade-up-sm" data-aos-delay="100">
                    Build Better Software Faster, The Future Of Development is Here
                </h1>
                        </div>
                    </div>
                </div>
                    ...
                    <div className="col" data-aos="fade-up-sm" data-aos-delay="150">
                        <div className="d-flex flex-column justify-between gap-6 h-full">
                            ...
                            <div className="flex-shrink-0">
                                <a href="/blog" className="arrow-link arrow-link-primary-dark gap-3 fs-sm">
