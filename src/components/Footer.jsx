        ...
        <footer className="footer bg-striped pt-10 pt-lg-15">
            <div className="container">
                <div className="row g-10">
                            ...
                            <div className="col-md-4 col-lg-4">
                                <div className="footer-widget text-center text-md-start">
                                    ...
                                    <ul className="link-list list-unstyled mb-0">
                                        ...
                                        <li>
                                            <a href="/blog">Software Solutions</a>
                                        </li>
                                        <li>
                                            <a href="/blog">Generative AI</a>
                                        </li>
                                        <li>
                                            <a href="/blog">Cloud Computing</a>
                                        </li>
                                    </ul>
                                </div>
                            </div>
                    ...
                    <div className="col-lg-3 order-lg-1 me-auto">
                        <div className="footer-widget text-center text-lg-start">
                            <a href="">
                                <img src="/assets/images/logo.svg" alt="Ijaad Labs" className="img-fluid" width="135" />
                            </a>
                            <p className="fs-sm mb-0 mt-4">
                                Leading software development agency specializing in full-stack solutions, mobile apps, and innovative
                                technology services.
                            </p>
                        </div>
                    </div>
                ...
                <div className="text-center py-6 mt-8">
                    <p className="fs-sm mb-0">Copyright <span className="text-primary-dark">Ijaad Labs</span> 2024</p>
                </div>
            </div>
        </footer>
    );
